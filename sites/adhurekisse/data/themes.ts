...
export const THEMES: Record<ThemeId, CinematicTheme> = {
  moonlit_city: {
    ...
    overlayTop: "rgba(10, 8, 20, 0.35)",
    overlayBottom: "rgba(10, 8, 20, 0.85)",
    vignetteColor: "rgba(10, 8, 20, 0.65)",
  ...
  twilight_city: {
    ...
    overlayTop: "rgba(18, 8, 28, 0.35)",
    overlayBottom: "rgba(18, 8, 28, 0.85)",
    vignetteColor: "rgba(18, 8, 28, 0.65)",
  ...
  rainy_window: {
    ...
    overlayTop: "rgba(8, 14, 20, 0.40)",
    overlayBottom: "rgba(8, 14, 20, 0.88)",
    vignetteColor: "rgba(8, 14, 20, 0.68)",
    gradientAngle: "180deg",
  },
  coastal_road: {
    id: "coastal_road",
    ...
    overlayTop: "rgba(8, 18, 16, 0.35)",
    overlayBottom: "rgba(8, 18, 16, 0.85)",
    vignetteColor: "rgba(8, 18, 16, 0.65)",
  ...
  golden_sunset: {
    ...
    overlayTop: "rgba(20, 12, 4, 0.35)",
    overlayBottom: "rgba(20, 12, 4, 0.85)",
    vignetteColor: "rgba(20, 12, 4, 0.65)",
  ...
  starry_mountain: {
    ...
    overlayTop: "rgba(6, 10, 20, 0.40)",
    overlayBottom: "rgba(6, 10, 20, 0.88)",
    vignetteColor: "rgba(6, 10, 20, 0.68)",
